const thanksHTML = `
<section id="thanks" class="page active">
  <div class="container mx-auto px-6 py-20 text-center">
      <i data-lucide="party-popper" class="mx-auto text-pink-500" style="width: 80px; height: 80px;"></i>
      <h2 class="font-display text-4xl font-bold text-gray-800 mt-8">¡Gracias por tu compra!</h2>
      <p class="max-w-2xl mx-auto mt-4 text-gray-600 text-lg">Tu pedido ha sido reservado.</p>
      <div class="mt-8 bg-white p-6 rounded-lg shadow-md inline-block text-left">
      ...
      <p class="mt-8 text-gray-600">Una vez hecha la transferencia, envía el comprobante a nuestro <br><strong>WhatsApp <a href="#" class="text-pink-500 underline">+54 9 11 1234-5678</a></strong>.</p>
