...
const aboutHTML = `
  <section id="about" class="page active" aria-labelledby="about-title">
    <div class="container mx-auto px-6 py-16 text-center">
        <h2 id="about-title" class="font-display text-4xl font-bold text-gray-800">Nuestra Historia</h2>
        <img src="https://placehold.co/300x300/FFF0F5/DB2777?text=LyM" alt="Logo de LyM Creaciones" class="w-48 h-48 rounded-full mx-auto my-8 object-cover shadow-lg"> <!-- Asegurarse que alt esté presente -->
